...
```
Based on the results above, the p-value is smaller than the level of significance, so we can reject the null hypothesis. We can conclude that the offline and online prices of pizza margherita are different in Budapest.
